				...
				<div class="header-container">
					...
					<div class="header-nav">
						<ul class="nav justify-content-end">
							<li class="dropdown dropdown-hover">
								...
								<div class="dropdown-menu dropdown-menu-cart p-0">
									...
									<div class="cart-body">
										<ul class="cart-item">
											<li>
												<div class="cart-item-image"><img src="../../../public/assets/img/product/product-12-1.jpg" alt="" /></div>
											...
											<li>
												<div class="cart-item-image"><img src="../../../public/assets/img/product/product-imac.jpg" alt="" /></div>
												<div class="cart-item-info">
											...
											<li>
												<div class="cart-item-image"><img src="../../../public/assets/img/product/product-iphone.png" alt="" /></div>
												<div class="cart-item-info">
							...
							<li class="divider"></li>
							<li>
                <router-link to="/login"> <!-- @click.prevent prevents navigation -->
...
import Modal from "../../Pages/Customer/CustModal.vue";
	...
	methods: {
		...
		async addcustomer() {
			const formData = { 
				...
				cust_surname: this.form.cust_surname, 
				email: this.form.email 
			};

			try {
				await axios.post(`${api}/customer`, formData); // Sending without cust_id
