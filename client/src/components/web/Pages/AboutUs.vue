				...
				<div class="row">
					...
					<div class="col-lg-3">
						...
						<ul class="fa-ul mb-lg-4 mb-0 p-0">
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Shopping Help</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Terms of Use</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Contact Us</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Careers</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Payment Method</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Sales & Refund</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Sitemap</a></li>
							<li><i class="fa fa-fw fa-angle-right"></i> <a href="#">Privacy & Policy</a></li>
						</ul>
					</div>
					<!-- END col-3 -->
					<!-- BEGIN col-3 -->
					<div class="col-lg-3">
						...
						<ul class="list-unstyled list-product mb-lg-4 mb-0 p-0">
							<li>
								<div class="image">
									<img src="../../../public/assets/img/product/product-iphone-6s.jpg" alt="" />
								</div>
								<div class="info">
							...
							<li>
								<div class="image">
									<img src="../../../public/assets/img/product/product-galaxy-s6.jpg" alt="" />
								</div>
								<div class="info">
							...
							<li>
								<div class="image">
									<img src="../../../public/assets/img/product/product-ipad-pro.jpg" alt="" />
								</div>
								<div class="info">
							...
							<li>
								<div class="image">
									<img src="../../../public/assets/img/product/product-galaxy-note5.jpg" alt="" />
								</div>
								<div class="info">
					...
					<div class="col-lg-3">
						...
						<address class="mb-lg-4 mb-0">
							...
							<abbr title="Email">Email:</abbr> <a href="/cdn-cgi/l/email-protection#3043515c5543705d4943585f401e535f5d"><span class="__cf_email__" data-cfemail="6f1c0e030a1c2f02161c07001f410c0002">[email&#160;protected]</span></a><br />
