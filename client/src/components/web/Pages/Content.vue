		 ...
		 <div id="slider" class="section-container p-0 bg-dark">
			...
			<div id="main-carousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<!-- BEGIN item -->
					<div class="carousel-item active" data-paroller="true" data-paroller-factor="0.3" data-paroller-factor-sm="0.01" data-paroller-factor-xs="0.01" style="background: url(../../../../public/assets/img/spa//slider/slider-1-cover.jpg) center 0 / cover no-repeat;">
						<div class="container">
							<img src="../../../../public/assets/img/spa/popular-regions-london-3.jpg" class="product-img right bottom animate__fadeInRight animate__animated" alt="" />
						</div>
                    ...
                    style="background: url(../../../../public/assets/img/spa/popular-regions-london-1.jpg) center 0 / cover no-repeat;">
						<div class="container">
							<img src="../../../../public/assets/img/spa/groups-2.jpg" class="product-img left bottom animate__fadeInLeft animate__animated" alt="" />
						</div>
					...
					<!-- BEGIN item -->
					<div class="carousel-item" data-paroller="true" data-paroller-factor="-0.3" data-paroller-factor-sm="0.01" data-paroller-factor-xs="0.01" 
                    style="background: url(../../../../public/assets/img/spa//slider/slider-3-cover.jpg) center 0 / cover no-repeat;">
					...
					<div class="col-lg-6">
						...
						<div class="promotion promotion-lg bg-dark">
							<div class="promotion-image text-end promotion-image-overflow-bottom">
								<img src="../../../public/assets/img/product/product-iphone-12.png" alt="" />
							</div>
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="promotion bg-blue">
							<div class="promotion-image promotion-image-overflow-bottom promotion-image-overflow-top">
								<img src="../../../public/assets/img/product/product-apple-watch-sm.png" alt="" />
							</div>
						...
						<div class="promotion bg-gray-200">
							<div class="promotion-image text-center promotion-image-overflow-bottom">
								<img src="../../../public/assets/img/product/product-mac-mini.png" alt="" />
							</div>
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="promotion bg-gray-200">
							<div class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-end">
								<img src="../../../public/assets/img/product/product-mac-accessories.png" alt="" />
							</div>
							<div class="promotion-caption text-center">
						...
						<div class="promotion bg-dark">
							<div class="promotion-image text-end">
								<img src="../../../public/assets/img/product/product-mac-pro.png" alt="" />
							</div>
							<div class="promotion-caption promotion-caption-inverse">
			...
			<div class="container">
				...
				<div class="row gx-2">
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<div class="item item-thumbnail">
							<a href="product_detail.html" class="item-image">
								<img src="../../../public/assets/img/product/product-iphone.png" alt="" />
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<div class="item item-thumbnail">
							<a href="product_detail.html" class="item-image">
								<img src="../../../public/assets/img/product/product-ipad-pro.png" alt=""  />
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<div class="item item-thumbnail">
							<a href="product_detail.html" class="item-image">
								<img src="../../../public/assets/img/product/product-imac.png" alt="" />
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<div class="item item-thumbnail">
							<a href="product_detail.html" class="item-image">
								<img src="../../../public/assets/img/product/product-apple-watch.png" alt="" />
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<div class="item item-thumbnail">
							<a href="product_detail.html" class="item-image">
								<img src="../../../public/assets/img/product/product-macbook-pro.png" alt="" />
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<div class="item item-thumbnail">
							<a href="product_detail.html" class="item-image">
								<img src="../../../public/assets/img/product/product-apple-tv.png" alt="" />
					...
					<div class="category-detail">
						...
						<a href="#" class="category-item full">
							<div class="item">
								<div class="item-cover">
									<img src="../../../public/assets/img/product/product-samsung-s7-edge.jpg" alt="" />
								</div>
						...
						<div class="category-item list">
							...
							<div class="item-row">
								...
								<div class="item item-thumbnail">
									<a href="product_detail.html" class="item-image">
										<img src="../../../public/assets/img/product/product-samsung-note5.png" alt="" />
										<div class="discount">32% OFF</div>
									</a>
									<div class="item-info">
										<h4 class="item-title">
								...
								<div class="item item-thumbnail">
									<a href="product_detail.html" class="item-image">
										<img src="../../../public/assets/img/product/product-iphone-se.png" alt="" />
										<div class="discount">20% OFF</div>
									</a>
									<div class="item-info">
										<h4 class="item-title">
							...
							<div class="item-row">
								...
								<div class="item item-thumbnail">
									<a href="product_detail.html" class="item-image">
										<img src="../../../public/assets/img/product/product-zenfone2.png" alt="" />
										<div class="discount">15% OFF</div>
									</a>
									<div class="item-info">
										<h4 class="item-title">
								...
								<div class="item item-thumbnail">
									<a href="product_detail.html" class="item-image">
										<img src="../../../public/assets/img/product/product-xperia-z.png" alt="" />
										<div class="discount">32% OFF</div>
									</a>
									<div class="item-info">
										<h4 class="item-title">
								...
								<div class="item item-thumbnail">
									<a href="product_detail.html" class="item-image">
										<img src="../../../public/assets/img/product/product-lumia-532.png" alt="" />
										<div class="discount">20% OFF</div>
									</a>
									<div class="item-info">
										<h4 class="item-title">
